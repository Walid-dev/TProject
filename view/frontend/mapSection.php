<div class="text-center pb-1 pt-2">
    <img id="activiteImg" class="img-fluid text-center" src="public/images/activites.png" width="140" alt="">
    <hr class="hr_title mb-1">
    <h4 class="text-center title_text pt-3 pb-4">Cette section vous permet d'ajouter, de s'inscrire à des évènements organisés par la communauté. <br>Cliquez deux fois sur la carte pour activer et désactiver le zoom, cliquez sur les marqueurs pour afficher les informations ou suivre les instructions pour ajouter un événement.</h4>
</div>
<div id="page">
    <nav>
        <div id="mapid"></div>
    ...
    <footer>
        <div id="buttons" class="map_box_button mt-2">
            <?php if (isset($_SESSION['userUid'])) : ?>
                <a class="add_event select_btn btn mx-auto btn-blue">Ajouter évènement</a>
            <?php else : ?>
                                        ...
                                        <div class="modal-body">
                                            <form class="modal_form" action="index.php" method="post">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <span class="ml-2" id='result8'></span>
                                                </div> <!-- form-group end.// -->
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <button id="validate3" type="submit" class="up btn modal_btn mt-3" name="signup-submit">Créer</button>
                                                </div> <!-- form-group// -->
                                            </form>
                                        </div>
                                        <!--Footer-->
                ...
                <a href="" class="event_connect_btn btn mx-auto btn-blue" data-toggle="modal" data-target="#modalLRForm">Se connecter pour ajouter un événement</a>
