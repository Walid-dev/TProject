<?php if (isset($_SESSION['userUid'])) : ?>
    <div id="eventSuscribeBox">
        <a id="" class="btn btn-blue">Je m'inscris</a>
    <?php else : ?>
    ...
    <a href="" class="btn ml-2 mt-2 btn-connect-event btn-pink" data-toggle="modal" data-target="#modalLRForm">Vous devez être connecté pour vous inscrire</a>
